...
.cat-hero-banner{position:relative;padding:70px 60px 48px;text-align:center;background:#FFFFFF;overflow:hidden;border-bottom:1px solid var(--border);}
...
.cat-desc{font-size:15px;font-weight:300;color:#6B6459;max-width:520px;margin:0 auto 26px;line-height:1.8;}
...
.cust-hero{text-align:center;padding:52px 60px 34px;border-bottom:1px solid var(--border);background:#FFFFFF;}
.cust-hero h1{font-family:'Cormorant Garamond',serif;font-size:clamp(38px,5vw,60px);font-weight:600;font-style:italic;background:linear-gradient(90deg,#7A5010 0%,#C4881A 20%,#F5D77A 35%,#FFF6D8 45%,#F0C840 55%,#C4901C 70%,#8B6212 100%);background-size:250% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;animation:shimmerGold 4s linear infinite;}
...
.hero-inner{padding-top:48px;padding-bottom:37px;}
...
.hero-inner{padding-top:38px;padding-bottom:28px;}
.cat-hero-banner{padding-top:38px;padding-bottom:28px;}
...
.cust-hero{padding:38px 20px 26px;}
