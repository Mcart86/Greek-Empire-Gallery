...
.cat-hero-banner{position:relative;padding:48px 60px 32px;text-align:center;background:#FFFFFF;overflow:hidden;border-bottom:1px solid var(--border);}
...
.cust-hero{text-align:center;padding:34px 60px 22px;border-bottom:1px solid var(--border);background:#FFFFFF;}
