...
footer{padding:36px 60px;border-top:1px solid var(--border);display:flex;justify-content:space-between;align-items:flex-start;gap:32px;}
...
.foot-right{display:flex;flex-direction:column;align-items:center;gap:16px;}
...
.foot-shield{width:56px;height:auto;opacity:0.9;}
